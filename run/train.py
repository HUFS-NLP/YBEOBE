...
g.add_argument("--model-path", type=str, default="beomi/KcELECTRA-base", help="model file path")
g.add_argument("--tokenizer", type=str, default="beomi/KcELECTRA-base", help="huggingface tokenizer path")
...
g.add_argument("--gpus", type=int, default=1, help="Number of GPUs to use")
